...
echo "Concatenating into processor.js..."

cat "$BUILD_DIR/rubberband-wasm.js" "$SRC_DIR/rubberband-processor.js" > "$BUILD_DIR/processor.js"

echo "Build complete: $BUILD_DIR/processor.js"
